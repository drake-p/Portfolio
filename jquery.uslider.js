        ...
        slideSize: function(){
            ...
            if (this.vars.sC != 0) {
                ...
                for (var a = 0; a < this.items.length; a++) 
                    a != this.vars.cS &&
                    (this.items.eq(a).children("img")[0].complete ? this.items.eq(a).children("img").siblings().width(this.items.eq(a).children("img").width() + "px") : this.items.eq(parseInt(a)).children("img").load(function(){
